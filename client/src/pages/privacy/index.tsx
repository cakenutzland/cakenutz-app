...
export default function PrivacyPage() {
  ...
  return (
    <div>
      ...
      <div className="max-w-3xl mx-auto p-4 sm:p-6 mt-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <Card className="border-0 shadow-sm bg-white rounded-2xl overflow-hidden border border-[#F0E5D1]">
          <CardContent className="p-6 sm:p-8 space-y-6 text-[#1A1A1A] text-sm leading-relaxed">
            ...
            <div>
              ...
              <p className="mt-2 text-[#1E73BE] font-medium uppercase">REALAPPSOLUTIONS@GMAIL.COM</p>
            </div>
